...
$(document).ready(function () {
  const a = setInterval(() => {
    const str = `&copy; Copyright <span style="color:black;">Dank</span><span style="color:red;font-weight:bolder;">Gh</span>
     ${new Date()}- Created By : <a href="javascript:void(null)">Addo Constant</a>`;
    $(".p-copy").html(str);
  }, 1000);
});
