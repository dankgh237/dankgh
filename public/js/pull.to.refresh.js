...
function update(handler) {
    let iconEl = handler.ptrElement.querySelector(("." + (handler.classPrefix) + "icon"));
...
let screenY = function screenY(event) {
...
let _setupEvents = (function () {
    let _el;

    function _onTouchStart(e) {
        // here, we must pick a handler first, and then append their html/css on the DOM
        let target = _shared.handlers.filter(function (h) { return h.contains(e.target); })[0];
    ...
    function _onTouchEnd() {
        ...
        if (_shared.state === 'releasing' && _shared.distResisted > _el.distThreshold) {
            ...
            _shared.timeout = setTimeout(function () {
                let retval = _el.onRefresh(function () { return _ptr.onReset(_el); });
    ...
    let _passiveSettings = _shared.supportsPassive ? {
...
let _ptrStyles = "\n.__PREFIX__ptr {\n  box-shadow: inset 0 -3px 5px rgba(0, 0, 0, 0.12); background:gainsboro !important;\n  pointer-events: none;\n  font-size: 0.85em;\n  font-weight: bold;\n  top: 0;\n  height: 0;\n  transition: height 0.3s, min-height 0.3s;\n  text-align: center;\n  width: 100%;\n  overflow: hidden;\n  display: flex;\n  align-items: flex-end;\n  align-content: stretch;\n}\n\n.__PREFIX__box {\n  padding: 10px;\n  flex-basis: 100%;\n}\n\n.__PREFIX__pull {\n  transition: none;\n}\n\n.__PREFIX__text {\n  margin-top: .33em;\n  color: rgba(0, 0, 0, 0.3);\n}\n\n.__PREFIX__icon {\n  color: rgba(0, 0, 0, 0.3);\n  transition: transform .3s;\n}\n\n/*\nWhen at the top of the page, disable vertical overscroll so passive touch\nlisteners can take over.\n*/\n.__PREFIX__top {\n  touch-action: pan-x pan-down pinch-zoom;\n}\n\n.__PREFIX__release .__PREFIX__icon {\n  transform: rotate(180deg);\n}\n";
...
let _methods = ['mainElement', 'ptrElement', 'triggerElement'];
let _setupHandler = (function (options) {
    let _handler = {}; // merge options with defaults
    ...
    _handler.destroy = function () {
        ...
        let offset = _shared.handlers.indexOf(_handler);
...
let index = {
    ...
    init: function init(options) {
        ...
        let handler = _setupHandler(options);
